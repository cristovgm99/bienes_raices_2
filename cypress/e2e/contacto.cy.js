...
describe('Prueba el formulario de Contacto', () => {
    ...
    it('Llena los campos del formulario', () => {
        cy.get('[data-cy="input-nombre"]').type('Cristobal')
        ...
        cy.get('[data-cy="input-telefono"]').type('987654321')
        cy.get('[data-cy="input-fecha"]').type('2022-06-21')
        cy.get('[data-cy="input-hora"]').type('19:30')
